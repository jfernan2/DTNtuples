...
class DTNtupleSegmentFiller : public DTNtupleBaseFiller
{
 ...
 private :
  ...
  std::vector<float> m_seg4D_posGlb_phi_midPlane; // position phi in global coordinates (float in radians [-pi:pi])
  std::vector<float> m_seg4D_posGlb_phi_SL1; // position phi in global coordinates (float in radians [-pi:pi])
  std::vector<float> m_seg4D_posGlb_phi_SL3; // position phi in global coordinates (float in radians [-pi:pi])
